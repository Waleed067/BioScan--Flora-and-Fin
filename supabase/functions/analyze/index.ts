...
You receive ONE photo. First decide if the subject is a PLANT or a FISH (or "unknown" if neither).
Then identify the species and assess health/diseases. Be specific, accurate, and practical.
...
const tool = {
  ...
  function: {
    name: "report",
    description: "Return a structured identification + diagnosis report.",
    parameters: {
      type: "object",
      properties: {
        ...
        healthStatus: {
          type: "string",
          enum: ["healthy", "minor_issues", "diseased", "critical", "unknown"],
        },
        diseases: {
          type: "array",
          items: {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: SYSTEM },
          {
            role: "user",
            content: [
              { type: "text", text: "Identify and diagnose the plant or fish in this image." },
