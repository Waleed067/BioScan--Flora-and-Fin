  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "assistant",
      content:
        "Hi! I'm your **BioScan Assistant** 🌿🐠 — ask me anything about plant care, fish health, diseases, or how to use the scanner.",
    },
  ]);
      ...
      >
        ...
        >
          ...
          <Button
            ...
            className="bg-gradient-hero text-primary-foreground shrink-0"
          >
